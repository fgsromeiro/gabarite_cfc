...
class BoardPanelEditLine extends StatelessWidget with ApplicationGlobalMixin {
  const BoardPanelEditLine({
    super.key,
        ...
        onTap: () async {
          if (permission.isProducts) {
            ...
            await showDialog<void>(
              ...
              builder: (context) {
                return BoardPanelEditLineDialog(
                  question: question,
                );
              },
            );
              ...
              children: [
                Stack(
                  ...
                  children: [
                    ...
                    BoardPanelInfoStatus(isFinished: question.isFilled),
                  ],
                ),
                BoardPanelLabelCard(
