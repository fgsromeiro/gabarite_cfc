...
class BoardPanelEditLineDialog extends StatefulWidget {
  const BoardPanelEditLineDialog({
    super.key,
  ...
  @override
  State<BoardPanelEditLineDialog> createState() => _BoardPanelEditLineDialogState();
}

class _BoardPanelEditLineDialogState extends State<BoardPanelEditLineDialog> {
